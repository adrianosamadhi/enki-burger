          ...
          <div className="bg-[#FF3D00]/5 border border-[#FF3D00]/15 rounded-[2rem] p-5 flex flex-col sm:flex-row gap-4 justify-between items-center text-left select-none">
            ...
            <div className="flex flex-wrap gap-2 w-full sm:w-auto">
              ...
              <button
                ...
                className="flex-1 sm:flex-none px-4 py-3 rounded-2xl text-xs font-black border border-blue-200 bg-blue-50 text-blue-600 hover:bg-blue-100 transition active:scale-95 cursor-pointer flex items-center justify-center gap-1.5"
              >
                🎵 Testar / Parar Som
              </button>
              <button
