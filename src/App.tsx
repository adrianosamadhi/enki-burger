...
import { safeStorage, calculateDynamicFreight, formatBRL, formatCEP, fetchAddressByCEP, getCartItemTotalPrice, getCartItemSinglePrice } from "./utils";
    ...
    try {
      ...
      if (data) {
        ...
        const mapped: Order[] = data.map((item: any) => ({
          ...
          rua: item.endereco.split("-")[0]?.trim() || "",
          numero: "",
          bairro: "",
          cep: "",
  ...
  return (
    <div className="bg-stone-50 text-neutral-950 min-h-screen pb-16 relative">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-24 lg:bottom-8 right-4 lg:right-8 bg-[#25D366] text-white p-4 rounded-full shadow-2xl hover:bg-[#1EBE57] transition-all duration-300 z-50 hover:scale-110 flex items-center justify-center animate-bounce group"
      >
